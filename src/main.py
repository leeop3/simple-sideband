        ...
        if message.is_image:
            ...
            if len(parts) == 3:
                ...
                temp_path = os.path.join(
                    tempfile.gettempdir(),
                    "msg_" + str(message.timestamp) + ".jpg"
                )
...
class SimpleChatApp(App):
    def build(self):
        # FIX: import moved to top of file; try/except correctly indented inside build()
        try:
